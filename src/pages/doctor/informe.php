    ...
    <main class="container mx-auto px-4 py-10">
        <div class="bg-card text-secondary border border-card rounded-xl p-6 print-content">
            ...
            <div class="flex justify-end space-x-3 mb-6 no-print">
                ...
                <a href="doctor" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors duration-200">
                    Volver
                </a>
            </div>
            ...
            <div class="print-header">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4 print-section">
                    ...
                    <div>
                        <p class="text-sm text-kinetic-700">Doctor</p>
                        <p class="font-semibold text-kinetic-900 print-text">Dr. <?= htmlspecialchars($informe['doctor_nombre']) ?></p>
                    </div>
                </div>
            ...
            <div class="prose max-w-none">
                ...
                <div class="bg-card p-4 rounded-lg border border-card print-text">
                    <?= nl2br(htmlspecialchars($informe['contenido'])) ?>
                </div>
            </div>
        </div>
    </main>
