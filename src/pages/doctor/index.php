<?php
    ...
    // Obtener próximas citas reales del doctor
    $sql = "SELECT c.*, 
...
<body class="bg-blue-light text-gray-900 min-h-screen">
    ...
    <button onclick="openModalChatDoctor()" id="chatDoctorBtn" class="fixed bottom-6 right-6 z-50 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg w-16 h-16 flex items-center justify-center text-3xl focus:outline-none focus:ring-2 focus:ring-blue-400">
