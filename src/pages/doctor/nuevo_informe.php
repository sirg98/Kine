...
if (
    ...
    $sql = "INSERT INTO informes (paciente_id, doctor_id, tratamiento_id, contenido, fecha) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('iiiss', $paciente_id, $doctor_id, $tratamiento_id, $contenido, $fecha);
    if ($stmt->execute()) {
