...
$tratamientos = [
    [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-activity h-6 w-6" data-lov-id="src\pages\Treatments.tsx:13:10" data-lov-name="Activity" data-component-path="src\pages\Treatments.tsx" data-component-line="13" data-component-file="Treatments.tsx" data-component-name="Activity" data-component-content="%7B%22className%22%3A%22h-6%20w-6%22%7D"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>',
        "titulo" => "Applied Kinesiology",
        "descripcion" => "Using muscle testing to evaluate body function and energy systems to identify imbalances and guide treatment. Our specialized approach combines traditional kinesiology with modern techniques for optimal results.",
        "beneficios" => [
            "Identifies muscular imbalances",
    ...
    [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bed-double h-6 w-6" data-lov-id="src\pages\Treatments.tsx:19:10" data-lov-name="BedDouble" data-component-path="src\pages\Treatments.tsx" data-component-line="19" data-component-file="Treatments.tsx" data-component-name="BedDouble" data-component-content="%7B%22className%22%3A%22h-6%20w-6%22%7D"><path d="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8"></path><path d="M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4"></path><path d="M12 4v6"></path><path d="M2 18h20"></path></svg>',
        "titulo" => "Structural Balance",
        "descripcion" => "Correcting postural imbalances and muscle function to improve overall physical wellbeing and movement.",
        "beneficios" => [
            "Improves posture",
    ...
    [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hand-heart h-6 w-6" data-lov-id="src\pages\Treatments.tsx:25:10" data-lov-name="HandHeart" data-component-path="src\pages\Treatments.tsx" data-component-line="25" data-component-file="Treatments.tsx" data-component-name="HandHeart" data-component-content="%7B%22className%22%3A%22h-6%20w-6%22%7D"><path d="M11 14h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 16"></path><path d="m7 20 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9"></path><path d="m2 15 6 6"></path><path d="M19.5 8.5c.7-.7 1.5-1.6 1.5-2.7A2.73 2.73 0 0 0 16 4a2.78 2.78 0 0 0-5 1.8c0 1.2.8 2 1.5 2.8L16 12Z"></path></svg>',
        "titulo" => "Emotional Stress Release",
        "descripcion" => "Techniques to identify and release emotional stress patterns stored in the body’s energy systems. Our holistic approach addresses both the physical and emotional components of wellness.",
        "beneficios" => [
            "Reduces anxiety",
    ...
    [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-thermometer h-6 w-6" data-lov-id="src\pages\Treatments.tsx:37:10" data-lov-name="Thermometer" data-component-path="src\pages\Treatments.tsx" data-component-line="37" data-component-file="Treatments.tsx" data-component-name="Thermometer" data-component-content="%7B%22className%22%3A%22h-6%20w-6%22%7D"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"></path></svg>',
        "titulo" => "Pain Management",
        "descripcion" => "Addressing chronic pain through identifying root causes and balanced approaches to healing. Our pain management plans are tailored to your specific needs.",
        "beneficios" => [
            "Reduces chronic pain",
            "Improves mobility",
    ...
    [
        "icon" => '<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="#21637f" stroke-linejoin="round" stroke-width="2" d="M2.98755 7.97095c0-.55229.44771-1 1-1H16.9253c.5523 0 1 .44771 1 1v7.95855c0 .5522-.4477 1-1 1H3.98755c-.55229 0-1-.4478-1-1V7.97095ZM20.9129 12.9419v-1.9834c0-.5523-.4478-1-1-1h-.9876c-.5523 0-1 .4477-1 1v1.9834c0 .5523.4477 1 1 1h.9876c.5522 0 1-.4477 1-1Z"/>
                    <path stroke="#21637f" stroke-linejoin="round" stroke-width="2" d="M5.9751 9.9585h8.9627v3.9834H5.9751V9.9585Z"/>
                    </svg>',
        "titulo" => "Performance Enhancement",
        "descripcion" => "Optimizing physical function and movement patterns for athletic performance and daily activities. We help you reach your full potential.",
        "beneficios" => [
...
<head>
    ...
    <title>Servicios - KineticCare</title>
            ...
            <?php foreach ($tratamientos as $t): ?>
                <div class="flex flex-col md:flex-row items-center gap-10">
                    <div class="flex-1">
                        ...
                        <div class="mb-4">
                            <span class="font-semibold text-lg text-kinetic-900">Key Benefits:</span>
