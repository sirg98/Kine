        ...
        <div class="mt-3">
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <input type="text" readonly class="bg-card text-kinetic-900 dark:text-gray-100 w-full px-3 py-2 border border-card rounded-lg bg-gray-100 text-kinetic-900" value="<?= htmlspecialchars($perfil['nombre'] . ' ' . $perfil['apellidos']) ?>">
                </div>
                <div>
                    <label class="block text-sm text-secondary mb-1">Email</label>
                    <input type="email" readonly class="bg-card text-kinetic-900 dark:text-gray-100 w-full px-3 py-2 border border-card rounded-lg bg-gray-100 text-kinetic-900" value="<?= htmlspecialchars($perfil['email']) ?>">
                </div>
                <div>
                    <label class="block text-sm text-secondary mb-1">Teléfono</label>
                    <input type="text" readonly class="bg-card text-kinetic-900 dark:text-gray-100 w-full px-3 py-2 border border-card rounded-lg bg-gray-100 text-kinetic-900" value="<?= htmlspecialchars($perfil['telefono'] ?? 'No registrado') ?>">
                </div>
                <div>
                    <label class="block text-sm text-secondary mb-1">Fecha de nacimiento</label>
                    <input type="date" readonly class="bg-card text-kinetic-900 dark:text-gray-100 w-full px-3 py-2 border border-card rounded-lg bg-gray-100 text-kinetic-900" value="<?= $perfil['fecha_nacimiento'] ? htmlspecialchars($perfil['fecha_nacimiento']) : '' ?>">
                </div>
