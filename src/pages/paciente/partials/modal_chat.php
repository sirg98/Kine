<?php
// Obtener los doctores con los que el paciente ha tenido citas
$sql = "SELECT DISTINCT d.id, d.nombre, d.apellidos, 'doctor' as tipo
        FROM citas c
        JOIN usuarios d ON c.doctor_id = d.id AND d.tipo = 'doctor'
    ...
    <div class="relative top-10 mx-auto p-0 border border-card w-full max-w-6xl shadow-lg rounded-md bg-blue dark:bg-gray-800 flex flex-col min-h-[650px]">
        ...
        <div class="flex flex-1">
            ...
            <div class="w-1/3 bg-card dark:bg-gray-700 border-r border-card p-4 overflow-y-auto rounded-l-md">
                ...
                <input type="text" id="buscadorDoctores" class="w-full mb-4 px-3 py-2 border border-card rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Buscar médico...">
                <div class="space-y-2">
...
// (La lógica de mensajes y selección de doctor se implementará después)
</script> 