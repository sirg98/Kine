...
<div id="modalHistorial" class="fixed inset-0 bg-gray-600 bg-opacity-50 dark:bg-gray-900 dark:bg-opacity-50 hidden overflow-y-auto h-full w-full">
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <div class="mt-1 text-sm text-kinetic-900">
                                        ...
                                        <p>Doctor: Dr. <?= htmlspecialchars($sesion['doctor_nombre']) ?></p>
                                        <p>Estado: 
