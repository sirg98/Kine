                    ...
                    <div>
                        ...
                        <?php if ($proxima_cita): ?>
                            ...
                            <div class="text-sm text-kinetic-700">
                                Dr. <?= htmlspecialchars($proxima_cita['doctor_nombre']) ?> - <?= htmlspecialchars($proxima_cita['tratamiento_nombre']) ?>
                            </div>
                        <?php else: ?>
                            <div class="text-base text-lg text-kinetic-900 mb-1 font-semibold">No tienes citas programadas</div>
                        <?php endif; ?>
                    </div>
                    <?php if ($proxima_cita): ?>
