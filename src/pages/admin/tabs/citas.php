<?php
// Obtener todas las citas con información de paciente y doctor
$sql = "SELECT 
            c.id,
            c.fecha,
            c.estado,
                    ...
                    <tr class="border-b border-card cita-row">
                        ...
                        <td class="px-4 py-2">
                            <div class="flex space-x-2">
                                ...
                                <button onclick="deleteCita(<?= $row['id'] ?>)" 
...
document.getElementById('editForm').addEventListener('submit', function(e) {
    ...
    console.log('Actualizar cita:', data);
...
function deleteCita(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta cita?')) {
        // Aquí puedes agregar la lógica para eliminar la cita mediante AJAX
